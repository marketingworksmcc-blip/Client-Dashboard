...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "flex flex-col gap-0 overflow-hidden rounded-xl bg-card text-card-foreground border border-border shadow-none",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center px-5 py-4 border-t border-border bg-muted/30",
        className
      )}
      {...props}
    />
